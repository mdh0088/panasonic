...
//     sql_query($query);
    ...
    $query = "update product set product_reco = 'O' where ";
...
//     sql_query($query);
    ...
    $query = "update product set product_indi = 'O' where ";
}else if ($lec_action == "series") {
    $query = "update product set product_series = 'O' where ";
}
else if($lec_action == "clear")
{
    $query = "update product set product_indi = '', product_reco = '' , product_series = ''where ";
}
