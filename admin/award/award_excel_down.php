...

{
    ...
    ->setCellValue("B$i", $row['award_title'])
    ->setCellValue("C$i", $row['award_from'])
    ->setCellValue("D$i", $row['award_conts'])
    ->setCellValue("E$i", $row['award_when'])
    ->setCellValue("F$i", $row['award_img']);
...
$filename = iconv("UTF-8", "EUC-KR", "수상경력");
