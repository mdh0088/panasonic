...
$type1_query="select distinct kor_title from product_cate where cate_type='1' and eng_title NOT LIKE '%KMEW%' ";
$type2_query="select distinct kor_title from product_cate where cate_type='2' and kmew_chk ='X'";
$type3_query="select distinct kor_title from product_cate where cate_type='3' and kmew_chk ='X'";
$type4_query="select distinct kor_title from product_cate where cate_type='4' and kmew_chk ='X'";
$type5_query="select distinct kor_title from product_cate where cate_type='5' and kmew_chk ='X'";
        ...
        <form id="productForm" name="productForm" action="product_proc.php" method="post">
            ...
            <div class="section">
            	...
            	<div class="basic-info">
        			...
        			<dl>
        				<dt>정격</dt>
        				<dd><input type="text"  name="product_rating" placeholder="정격"></dd>
        			</dl>
        			<dl>
        				<dt>정격(영문)</dt>
        				<dd><input type="text"  name="product_rating_en" placeholder="정격"></dd>
        			</dl>
        			<dl>
        				<dt>사이즈</dt>
        			...
        			<dl>
        				<dt>사이즈(영문)</dt>
        				<dd><input type="text"  name="product_size_en" placeholder="사이즈"></dd>
        			</dl>
        			<dl>
        				<dt>인증</dt>
        				<dd><input type="text"  name="product_auth" placeholder="인증"></dd>
        			</dl>
        			<dl>
        				<dt>인증(영문)</dt>
        				<dd><input type="text"  name="product_auth_en" placeholder="인증"></dd>
        			</dl>
        			<dl>
        				<dt>인증서</dt>
        				<dd><input type="file" name="product_auth_file[]"></dd>
        			</dl>
        			<dl>
        				<dt>매뉴얼</dt>
        				<dd><input type="file" name="product_manual[]"></dd>
        			</dl>
        			<dl>
        				<dt>도면 (DWG)</dt>
        				<dd><input type="file" name="product_map_1[]"></dd>
        			</dl>
        			<dl>
        				<dt>도면 (PDF)</dt>
        				<dd><input type="file" name="product_map_2[]"></dd>
        			</dl>
        			<dl>
        				<dt>섬네일</dt>
        			...
        			<dl>
        				<dt>제품 설명</dt>
        				<dd><textarea name="product_info"></textarea></dd>
        			</dl>
        			<dl>
        				<dt>제품 설명(영문)</dt>
        				<dd><textarea name="product_info_en"></textarea></dd>
        			</dl>
