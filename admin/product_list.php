...
{
    $query .= " order by {$_POST['s
ort_type']} {$_POST['order_by']}";
}
else
{
    $query .= " order by idx";
...
<div id="main" class="container">
    ...
    <div class="clearfix">
        ...
        <div class="btn-wrap">
            ...
            <input class="g-btn" type="button" value="시리즈 선정" onclick="lec_action('series')">
            <input class="g-btn" type="button" value="선택 선정 취소" onclick="lec_action('clear')">
	        <a href="javascript:winOpen('product.php');" class="new-btn"><input class="blue" type="button" value="신규등록"></a>
        </div>
    </div>
    ...
    <!--     		<td><a href=""><img alt="" src="/img/<?php echo $row['product_img']?>"></a></td>   	 -->	
        		...
        		<td class="text-left name"><a href="javascript:winOpen('product_edit.php?idx=<?php echo $row['idx']?>');" ><?php echo $row['product_title'].'/'.$row['product_title_en']?></a></td> 
    <!--    		<td><?php echo $row['product_rating']?></td> 
        		...
        		<td><a href="/map/<?php echo $row['product_map_1']?>"><?php echo $row['product_map_1']?></a></td>
        		<td><a href="/map/<?php echo $row['product_map_2']?>"><?php echo $row['product_map_2']?></a></td>
        		...
        		<td><?php echo $row['product_indi']?></td>
