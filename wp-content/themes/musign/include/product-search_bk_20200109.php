...
$product_cnt_query = "SELECT count(*) as cnt FROM product WHERE product_cate1 LIKE '%{$keyword}%' or product_cate2 LIKE '%{$keyword}%'
...
$kmew_cnt_query = "select count(*) as cnt from kmew where product_cate1 LIKE '%{$keyword}%' or product_cate2 LIKE '%{$keyword}%'
or product_cate3 LIKE '%{$keyword}%' or product_cate4 LIKE '%{$keyword}%' or product_model LIKE '%{$keyword}%'
or product_title LIKE '%{$keyword}%' or product_ea LIKE '%{$keyword}%' or product_weight LIKE '%{$keyword}%'";
...
FROM product WHERE product_cate1 LIKE '%{$keyword}%' OR product_cate2 LIKE '%{$keyword}%' OR product_cate3 LIKE '%{$keyword}%' OR product_cate4 LIKE '%{$keyword}%' OR product_thumb LIKE '%{$keyword}%' OR
product_model LIKE '%{$keyword}%' OR product_title LIKE '%{$keyword}%' OR product_size LIKE '%{$keyword}%' OR product_rating LIKE '%{$keyword}%' OR product_auth LIKE '%{$keyword}%'  
...
FROM kmew WHERE product_cate1 LIKE '%{$keyword}%' OR product_cate2 LIKE '%{$keyword}%' OR product_cate3 LIKE '%{$keyword}%' OR product_cate4 LIKE '%{$keyword}%' OR product_thumb LIKE '%{$keyword}%' OR
product_model LIKE '%{$keyword}%' OR product_title LIKE '%{$keyword}%' OR product_size LIKE '%{$keyword}%' OR product_ea LIKE '%{$keyword}%' OR product_weight LIKE '%{$keyword}%' LIMIT {$search}, {$limit} ";
