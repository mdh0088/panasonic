...
///////////////// 메인 검색 //////////////////////
function main_search_shortcode($atts) {    
    ob_start();
    include(TEMPLATEPATH.'/include/main-search.php');
    $content = ob_get_clean();
    return $content;
}
add_shortcode('main_search', 'main_search_shortcode');

///////////////// 메인 제품 슬라이드 //////////////////////
function main_product_shortcode($atts) {    
    ob_start();
    include(TEMPLATEPATH.'/include/main-product.php');
    $content = ob_get_clean();
    return $content;
}
add_shortcode('main_product', 'main_product_shortcode');

///////////////// 연혁 슬라이드 //////////////////////
function history_shortcode($atts) {
    ob_start();
    include(TEMPLATEPATH.'/include/history.html');
    $content = ob_get_clean();
    return $content;
}
...
///////////////// 연혁 슬라이드(영문) //////////////////////
function history_en_shortcode($atts) {
    ob_start();
    include(TEMPLATEPATH.'/include/history-en.html');
    $content = ob_get_clean();
    return $content;
}
add_shortcode('history_en', 'history_en_shortcode');

///////////////// 지점 소개 //////////////////////
function store_shortcode($atts) {
    ob_start();
    include(TEMPLATEPATH.'/include/store-list.php');
    $content = ob_get_clean();
    return $content;
}
...
///////////////// 제품 상세 //////////////////////
function product_detail_shortcode($atts) {
    ob_start();
    include(TEMPLATEPATH.'/include/product-detail.php');
    $content = ob_get_clean();
    return $content;
}
add_shortcode('product_detail', 'product_detail_shortcode');

///////////////// 제품 상세 html //////////////////////
function product_detail_html_shortcode($atts) {
    ob_start();
    include(TEMPLATEPATH.'/include/product-detail.html');
    $content = ob_get_clean();
    return $content;
}
add_shortcode('product_detail_html', 'product_detail_html_shortcode');
...
///////////////// 제품 상세 - 카드형 //////////////////////
function product_detail_card_shortcode($atts) {
    ob_start();
    include(TEMPLATEPATH.'/include/product-detail-card.php');
    $content = ob_get_clean();
    return $content;
}
add_shortcode('product_detail_card', 'product_detail_card_shortcode');

///////////////// 인증서 //////////////////////
function cert_list_shortcode($atts) {
    ob_start();
    include(TEMPLATEPATH.'/include/cert-list.php');
    $content = ob_get_clean();
    return $content;
}
...
///////////////// 검색결과 //////////////////////
function product_search_shortcode($atts) {
    ob_start();
    include(TEMPLATEPATH.'/include/product-search.php');
    $content = ob_get_clean();
    return $content;
}
...
///////////////// 제품 인트로 //////////////////////
function product_intro_shortcode($atts) {
    ob_start();
    include(TEMPLATEPATH.'/include/product-intro.php');
    $content = ob_get_clean();
    return $content;
}
add_shortcode('product_intro', 'product_intro_shortcode');

///////////////// 사이트맵 //////////////////////
function sitemap_all_shortcode($atts) {
    ob_start();
    include(TEMPLATEPATH.'/include/sitemap.php');
    $content = ob_get_clean();
    return $content;
}
add_shortcode('sitemap_all', 'sitemap_all_shortcode');
...
function custom_menu() {
    echo '<style>.notice, div.error, div.updated{margin-left:2px;} a.winbtn{padding:10px 20px; display:inline-block; text-decoration:none; color:#fff; background:#333; margin-right:10px;} a.winbtn:hover{background:#0041c0;}</style><br><br><a href="/admin/product_list.php" target="_blank" class="winbtn">제품 관리</a><a href="/admin/cert_list.php" target="_blank" class="winbtn">인증서 관리</a><a href="/admin/customer/customer_list.php" target="_blank" class="winbtn">영업지점 관리</a>';
}
